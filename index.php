    ...
    <body class="page">
        <header id="header" class="hero">
            ...
            <div class="hero-body">
                ...
                <p class="typography utp">по цене в 3 раза дешевле индивидуальных уроков</p>
        ...
        <main id="content">
                                ...
                                <?php
                                    $items = [
                                        ...
                                        [
                                            ...
                                            'description' => 'Обучение в группе стоит в 3 раза дешевле индивидуального: 260 руб. против 870 руб. за академ. час.'
                                        ],
                                        [
                                            'image' => 'thumbs-up-sign.png',
            ...
            <section id="lesson" class="section">
                ...
                <div class="box video">
                    <iframe src="https://www.youtube-nocookie.com/embed/jSfeDjvLxlI?controls=0&rel=0&showinfo=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </section>
